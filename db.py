...
SCHEMA_STATEMENTS = [
    # TODO: Replace runtime schema patching with real migrations once the backend model settles.
    """
    ALTER TABLE users
...
def ensure_schema():
    # TODO: Remove this bootstrap-time schema mutation path after migrating to a proper
    # migration workflow and a single schema source of truth.
    with db_connection() as conn:
        with conn.cursor() as cur:
